...
<p align="center">
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/chrismantinsdev/desafio-fundamentos-nodejs-typeorm-multer?color=%2304D361">
...
Nesse desafio, foi desenvolvido o backend de uma aplicação de gestão de transações, para treinar os conhecimentos de Node.js junto ao TypeScript, usando banco de dados com o TypeORM e envio de arquivos com o Multer!

Esta aplicação armazena transações financeiras de entrada e saída e permitir o cadastro e a listagem dessas transações, além de permitir a criação de novos registros no banco de dados a partir do envio de um arquivo csv.
